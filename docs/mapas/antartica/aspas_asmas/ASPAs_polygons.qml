...
<qgis readOnly="1" version="3.16.1-Hannover" simplifyMaxScale="1" simplifyDrawingHints="0" labelsEnabled="1" styleCategories="AllStyleCategories" minScale="100000000" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" maxScale="0">
  ...
  <labeling type="rule-based">
    <rules key="{ae3a0571-286b-4955-8594-b5cd7ec07e52}">
      <rule key="{f5f19b50-de6e-4875-a234-7b6952ce2e2e}" description="Out">
        <settings calloutType="simple">
          ...
          <placement distUnits="MM" offsetType="0" rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placement="1" layerType="UnknownGeometry" repeatDistance="0" lineAnchorPercent="0.5" quadOffset="4" dist="0" distMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MapUnit" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" centroidWhole="0" xOffset="0" preserveRotation="1" geometryGeneratorType="PointGeometry" overrunDistanceUnit="MM" yOffset="0" maxCurvedCharAngleIn="25" overrunDistance="0" lineAnchorType="0" fitInPolygonOnly="0" geometryGeneratorEnabled="0" maxCurvedCharAngleOut="-25" repeatDistanceUnits="MM" polygonPlacementFlags="2" centroidInside="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" priority="5"/>
      ...
      <rule key="{1c7c4483-deb1-41cb-a3df-43008d87db5c}" description="In">
        <settings calloutType="simple">
  ...
  <customproperties>
    ...
    <property value="229" key="labeling/bufferColorG"/>
    ...
    <property value="FIRSTNAME || '\n (ASPA No. '  ||  &quot;ASPA_No&quot;  || ')'" key="labeling/fieldName"/>
    ...
    <property value="12" key="labeling/fontSize"/>
    ...
    <property value="84" key="labeling/textColorR"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="FIRSTNAME">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="0" type="QString" name="IsMultiline"/>
  ...
  <aliases>
    ...
    <alias index="7" name="" field="FIRSTNAME"/>
  </aliases>
  <defaults>
    ...
    <default expression="" field="FIRSTNAME" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="FIRSTNAME"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="FIRSTNAME" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="FIRSTNAME"/>
    </columns>
